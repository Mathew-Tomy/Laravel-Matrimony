...
Route::get('/blog/{slug}', 'BlogController@blog_details')->name('blog.details');
    ...
    Route::get('/encounter', 'UsersEncountersController@show_encounter')->name('show_encounter');
 
    Route::get('/like_user/{user_id}', 'UsersEncountersController@likeUser')->name('encounter.like_user');

    Route::get('/skip_user/{user_id}', 'UsersEncountersController@skip_user')->name('encounter.skip_user');

    Route::get('/dislike_user/{user_id}', 'UsersEncountersController@dislikeUser')->name('encounter.dislike_user');

    Route::get('/view-like-user', 'UsersEncountersController@View_like_User')->name('like-users');

    Route::get('/view-dislike-user', 'UsersEncountersController@View_dislike_User')->name('dislike-user');
    ...
    Route::get('/profile-viewed-by-me', 'ProfileViewController@viewed_by_me')->name('viewed-by-me');
    Route::get('/profile-visitors', 'ProfileViewController@profile_visitors')->name('profile_visitors');
