    ...
    <div class="aiz-user-sidenav rounded overflow-hidden">
        ...
        <div class="sidemnenu mb-3">
            <ul class="aiz-side-nav-list" data-toggle="aiz-side-menu">
                ...
                <li class="aiz-side-nav-item">
                    <a href="{{ route('show_encounter') }}" class="aiz-side-nav-link">
                        <i class="las la-heart aiz-side-nav-icon"></i>
                        <span class="aiz-side-nav-text">{{ translate('Encounter') }}</span>
                    </a>
                </li>
                <li class="aiz-side-nav-item">
                ...
                <li class="aiz-side-nav-item">
                    <a href="{{ route('interest_requests') }}" class="aiz-side-nav-link">
                        <i class="la la-heart-o aiz-side-nav-icon"></i>
                        <span class="aiz-side-nav-text">{{ translate('Received Interest') }}</span>
                    </a>
                </li>
                ...
                <li class="aiz-side-nav-item">
                    <a href="{{route('profile_visitors')}}" class="aiz-side-nav-link">
                        <i class="las la-eye aiz-side-nav-icon"></i>
                        <span class="aiz-side-nav-text">{{ translate('Profile Visitors') }}</span>
                    </a>
                </li>

                <li class="aiz-side-nav-item">
                    <a href="{{route('viewed-by-me')}}" class="aiz-side-nav-link">
                        <i class="las la-eye aiz-side-nav-icon"></i>
                        <span class="aiz-side-nav-text">{{ translate('Profile Viewed by me') }}</span>
                    </a>
                </li>
                ...
                <li class="aiz-side-nav-item">
                    <a href="{{route('like-users')}}" class="aiz-side-nav-link">
                        <i class="las la-thumbs-up aiz-side-nav-icon"></i>
                        <span class="aiz-side-nav-text">{{ translate('Liked users') }}</span>
                    </a>
                </li>
   
                <li class="aiz-side-nav-item">
                    <a href="{{route('dislike-user')}}" class="aiz-side-nav-link">
                        <i class="las la-thumbs-down aiz-side-nav-icon"></i>
                        <span class="aiz-side-nav-text">{{ translate('Disliked users') }}</span>
                    </a>
                </li>
