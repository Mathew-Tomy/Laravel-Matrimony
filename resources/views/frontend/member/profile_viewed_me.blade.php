            ...
            <table class="table aiz-table mb-0">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>{{ $key + 1 }}</td>
                        <td>
                            <a href="{{ route('member_profile', $visitor->viewer->id) }}" class="text-reset c-pointer">
                                @if (uploaded_asset($visitor->viewer->photo) != null)
                                    <img class="img-md" src="{{ uploaded_asset($visitor->viewer->photo) }}" height="45px" alt="{{ translate('photo') }}">
                                @else
                        ...
                        <td>
                            <a href="{{ route('member_profile', $visitor->viewer->id) }}" class="text-reset c-pointer">
                                {{ $visitor->viewer->first_name . ' ' . $visitor->viewer->last_name }}
                            </a>
                        </td>
                    </tr>
                @endforeach
