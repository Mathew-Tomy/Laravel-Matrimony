...
<head>
    ...
    <link rel="stylesheet" href="{{ public_asset('assets/css/vendors.css') }}">
    <link rel="stylesheet" href="{{ public_asset('assets/css/aiz-core.css') }}">
    <link rel="stylesheet" href="{{ public_asset('assets/css/custom-style.css') }}">
    ...
    @if (\App\Models\Language::where('code', Session::get('locale', Config::get('app.locale')))->first()->rtl == 1)
        <link rel="stylesheet" href="{{ public_asset('assets/css/bootstrap-rtl.min.css') }}">
    @endif
...
<body class="text-left">
    ...
    @endif
    {{-- <script src=" {{ public_asset('assets/js/vendors.js') }}"></script>
   <script src=" {{ public_asset('assets/js/aiz-core.jS') }}"></script> --}}


    <script data-cfasync="false" src="/cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js">
    </script><script src="https://demo.activeitzone.com/matrimonial/public/assets/js/vendors.js"></script>
